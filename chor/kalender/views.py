...
def kalender_home_view(request):
    ...
    return render_to_response("kalender/home.html",{'day':today.day,'month':today.month,'month_name':month_names[today.day-1],'year':today.year,'Kalender':kalender,},context_instance=RequestContext(request))
